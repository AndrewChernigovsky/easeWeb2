...
module.exports = function (options) {
  return () => {
    gulp.watch(`[!./${options.src}/js/**/*, ./${options.src}/js/**/*]`, gulp.series(options.tasks.esLint, options.tasks.buildCustomJs));

    gulp.watch(`./${options.src}/**/*`, gulp.series(options.tasks.esLint, options.tasks.buildCustomJs));
